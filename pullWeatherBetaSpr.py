...
"""
file structure
timeStamp,tempInFahrenheit['temp'],humidity,detailedStatus,rainVolume,wind-deg,wind-speed,clouds
"""
def buildRow(owm):
    weatherRow = []
    observation = owm.weather_at_place('springfield,il')
...
weatherFile = theDate + "_weather_obs_spr.txt"
delimiter = ','
row = buildRow(owm)
